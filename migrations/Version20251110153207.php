 ...
 */
final class Version20251110153207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tranche_quotient (id INT AUTO_INCREMENT NOT NULL, nom_tranche VARCHAR(255) NOT NULL, quotient_min INT NOT NULL, quotient_max INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
